...
public class PortfolioController {
    ...
    public void handlePortfolioClick() {
        ...
        LineChart<String, Number> lineChart1 = new LineChart<>(new CategoryAxis(), new NumberAxis());
        ...
        graphPane2.setLayoutY(360);
        graphPane2.setPrefHeight(262);
